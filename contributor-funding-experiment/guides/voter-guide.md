...
2. Review the contributor candidate proposals and fill in the contributor candidate selection Google Sheet. The contributor selection Google Sheet can be found here - \[LINK].
3. Download the completed Google Sheet contributor selection as a Microsoft Excel file (.xlsx).
4. Submit your voter ID and Microsoft Excel file in the following form - LINK. Do not complete this form more than once as this will invalidate your vote.
5. Votes will be aggregated and then the voting results will be shared publicly. Votes will remain anonymous.
